...
public class SolarController : MonoBehaviour
{
    ...
    public static Vector3 containerBasePos = Vector3.zero;
    public static Vector3 containerStartPos = Vector3.zero;
    public static Vector3 containerEndPos = Vector3.zero;
}