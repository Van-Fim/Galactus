...
public class CameraController : MonoBehaviour
{
    ...
    public static List<Vector3> startCamPositions = new List<Vector3>();
    bool isCamEnabled = true;
    ...
    void Start()
    {
        ...
        startCamPositions.Add(new Vector3(0, 5000, 0));
    ...
    void Update()
    {
        ...
        {
            Vector2 lastAxis = new Vector2(Input.GetAxis("Mouse X"), Input.GetAxis("Mouse Y"));
            //Vector2 lastAxis = new Vector2(Input.mousePosition.x, Input.mousePosition.y);
            //Debug.Log(lastAxis);
            var mouseMovement = new Vector2(lastAxis[0], lastAxis[1] * (invertY ? 1 : -1));
