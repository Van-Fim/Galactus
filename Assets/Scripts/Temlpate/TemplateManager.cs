...
public class TemplateManager
{
    ...
    public static void Func01(XmlNode node, Template template, int depth = 0, TemplateNode parentNode = null)
    {
        ...
        for (int i = 0; i < childNodes.Count; i++)
        {
            ...
            Func01(xmlNode, template, depth+1, templateNode);
        }
    }
    ...
    public static List<Template> LoadTemplates(string node, string patch, bool addToTemplates = true)
    {
        ...
        for (int i = 0; i < nodes.Count; i++)
        {
            ...
            Func01(nodeItem, template, depth);
            if (template == null)
                continue;
            ...
            for (int j = 0; j < childNodes.Count; j++)
            {
                ...
                Func01(childNode, template, depth+1);
            }
